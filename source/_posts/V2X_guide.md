...
- 雷达只能探测到周围车辆，但是探测不到前车的前车的情况，有各种盲区。

![车辆盲区](/images/V2X_mangqu.gif)

这时候，通过车联网，车与车之间数据交换，获取到其他车辆的视野信息，盲区就消除了。

- 用摄像头识别红绿灯，随便来个下雨天，还不知道能不能识别出红绿灯。

![下雨天的红绿灯](/images/V2X_hld.jpg)
...
![车联网V2X](/images/V2X.png)
 
## V2X是如何联接的
V2X多方通信，汽车又在高速移动，**只能用无线通信**，而且最好是成熟的，稳定的无线通信方式。要说成熟稳定的无线通信，**首先想到的就是2G/3G/4G了**，它们是基于基站组合的通信网络，车联网使用类似4G网络的通信，这就是C-V2X，C是Cellular的简写（蜂窝，一个个基站组合起来像蜂窝）。
...
### RSU路侧单元提供商
RSU（Road Side Unit）是在安装在路测的设备，RSU中要内置通信模组：

![车联网RSU](/images/V2X_RSU.png)
...
![车联网OBU](/images/V2X_OBU.png)

OBU代表了车，车通过OBU和其他事物通信：车和车通过OBU交互，比如交换双方的车速，人和车通过OBU交互，比如语音识别控制车辆。
...
**MEC不但为车联网专用，随着5G的不断成熟，MEC会扩展到各行各业，如工业制造**，MEC涉及多方合作：
- MEC硬件服务器提供商
- MEC服务/应用提供商
- MEC运营商，估计还是移动运营商为主

### 车联网安全
车联网安全很重要，犹如车辆的安全一样重要，如何防范攻击，如何过滤非法设备，类似HTTPS中的证书，车联网也需要CA证书授权(Certificate Authority)。

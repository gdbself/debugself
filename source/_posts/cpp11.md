...
[2.auto关键字:自动推导变量类型](#002)

[3.更方便的for循环](#003)

[4.tuple元组](#004)

[5.nullptr关键字：更安全的空指针](#005)

[6.新增类型转换函数std::to_string/std::stoi/stol/stoll](#006)

[7.更方便，更安全的智能指针shared_ptr](#007)

[8.更方便的函数：lambda表达式](#008)

[9.功能能强的回调函数：function和bind](#009)

[10.效率更高的右值引用、std::move、emplace_back](#010)
...
[14.mutable关键字：突破const关键字的限制](#014)
...
6.新增类型转换函数std::to_string/std::stoi/stol/stoll
...
*   可变参数模板：STL库的实现很多都基于可变参数模板实现的。C++11大量使用了模板各种奇淫技巧，模板的用法真是无穷无尽，有了模板的存在，谁还敢说精通C++?![](http://img.baidu.com/hi/face/i_f31.gif)。
